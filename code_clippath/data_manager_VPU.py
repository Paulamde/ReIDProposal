...
class AICityTrack2(BaseVideoDataset):
    ...
    def __init__(self, root='D:/2019-CVPR-AIC-Track-2-UWIPL-master', min_seq_len=0, verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICITY_VPU/image_train_deepreid')
        #self.train_dir = osp.join(self.dataset_dir, '/media/twhuang/NewVolume1/aic19/aic19-track1-reid/track12_train/train')
        self.query_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICITY_VPU/image_query_deepreid')
        self.gallery_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICITY_VPU/image_test_deepreid')
