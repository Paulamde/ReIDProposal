...
class AICityTrack2(BaseVideoDataset):
    ...
    """
    dataset_dir_train = 'AICity_SyNew'
    #dataset_dir = 'Syntheticcontestveri'
    dataset_dir = 'AICity_SyNew'
    def __init__(self, root='D:/2019-CVPR-AIC-Track-2-UWIPL-master', min_seq_len=0, verbose=True, **kwargs):
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.dataset_url = 'http://vision.cs.duke.edu/DukeMTMC/data/misc/DukeMTMC-VideoReID.zip'
        self.train_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity_SyNew/image_train_deepreid')
        #self.train_dir = osp.join(self.dataset_dir, '/media/twhuang/NewVolume1/aic19/aic19-track1-reid/track12_train/train')
        self.query_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity_SyNew/image_query_deepreid')
        self.gallery_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity_SyNew/image_test_deepreid')
        ...
        self.split_query_json_path = osp.join(self.dataset_dir_train, 'split_query.json')
        self.split_gallery_json_path = osp.join(self.dataset_dir_train, 'split_gallery.json')
...
class AICityTrack3(BaseVideoDataset):
    """
    DukeMTMCVidReID
    ...
    # tracklets: 2196 (train) + 2636 (test)
    """
    dataset_dir = 'AiCIty_MTMC'

    def __init__(self, root='D:/2019-CVPR-AIC-Track-2-UWIPL-master', min_seq_len=0, verbose=True, **kwargs):
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.dataset_url = 'http://vision.cs.duke.edu/DukeMTMC/data/misc/DukeMTMC-VideoReID.zip'
        #self.train_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity/image_train_deepreid')
        # self.train_dir = osp.join(self.dataset_dir, '/media/twhuang/NewVolume1/aic19/aic19-track1-reid/track12_train/train')
        self.query_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity_SyNew/image_query_deepreid')
        self.gallery_dir = osp.join(self.dataset_dir,
                                    'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity_SyNew/image_test_deepreid')
        #self.split_train_json_path = osp.join(self.dataset_dir, 'split_train.json')
        #self.split_train_orig_json_path = osp.join(self.dataset_dir, 'split_train_orig.json')
...
class Mars(object):
    ...
    def __init__(self, min_seq_len=0):
        ...
        train, num_lets, num_train_pids, num_train_imgs = \
