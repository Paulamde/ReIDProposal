...
class AICityTrack2(BaseVideoDataset):
    ...
    """
    dataset_dir_test = 'AICity'
    dataset_dir = 'VeRi_with_plate'
    def __init__(self, root='D:/2019-CVPR-AIC-Track-2-UWIPL-master', min_seq_len=0, verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/VeRi_with_plate/image_train_deepreid')
        #self.train_dir = osp.join(self.dataset_dir, '/media/twhuang/NewVolume1/aic19/aic19-track1-reid/track12_train/train')
        self.query_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity/image_query_deepreid')
        self.gallery_dir = osp.join(self.dataset_dir, 'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity/image_test_deepreid')
        ...
        self.split_query_json_path = osp.join(self.dataset_dir_test, 'split_query.json')
        self.split_gallery_json_path = osp.join(self.dataset_dir_test, 'split_gallery.json')
...
class AICityTrack3(BaseVideoDataset):
    ...
    def __init__(self, root='D:/2019-CVPR-AIC-Track-2-UWIPL-master', min_seq_len=0, verbose=True, **kwargs):
        ...
        self.gallery_dir = osp.join(self.dataset_dir,
                                    'D:/2019-CVPR-AIC-Track-2-UWIPL-master/AICity/image_test_deepreid')
        #self.split_train_json_path = osp.join(self.dataset_dir, 'split_train.json')
        #self.split_train_orig_json_path = osp.join(self.dataset_dir, 'split_train_orig.json')
