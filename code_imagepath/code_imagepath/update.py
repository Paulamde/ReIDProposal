...
def main():
    ...
    # save feature
    np.save('D:/feature_learning-master/Feature_Learning/learning_model/data/feature_expansion/' + cfg.TEST.QF_NAME, qf.cpu().numpy())
    np.save('D:/feature_learning-master/Feature_Learning/learning_model/data/feature_expansion/' + cfg.TEST.GF_NAME, gf.cpu().numpy())
